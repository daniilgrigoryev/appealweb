...
export default {
	...
	ishDocList: {
		...
		PODPISAL: 		 {name: 'podpisal_id',	   label: 'Подписал',					key:'EMPLOYESS_LIST'},
		STATUS: 		 {name: 'status',		   label: 'Статус'},
		DETAIL_INF: 	 {name: 'detail_inf', 	   label: 'Детальная информация'},
		REL_TOPIC: 		 {name: 'linked_theme_id', label: 'Связанная тема',			key: 'related_topic'},
		CRYPTO_SIGN: 	 {name: 'crypto_signature',label: 'Подпись с ЭП'},
		DOC_VID: 		 {name: 'doc_vid_id',	   label: 'Вид документа', 				key: 'doc_vid'},
		DELIV_TYPE: 	 {name: 'delivery_type_id',label: 'Способ доставки',				key: 'DELIVERY_METHOD'},
