        ...
        const ROWS = fields.map((x, i) => (<tr key={i}>
            ...
            <td>
                 <span className='inline-block mr12'>
                     <Field disabled={disabled} component={FSelect} name={x + M.QUEST.name} value={x[M.QUEST.name]} dataKey={M.QUEST.key} props={{readonly: true}} />
                 </span>
            </td>
            <td>
                <span className='inline-block mr12'>
                    <Field disabled={disabled} component={FSelect} name={x + M.DEPART.name} value={x[M.DEPART.name]} dataKey={M.DEPART.key} props={{readonly: true}}/>
                </span>
            </td>
            <td>
                <span className='inline-block mr12'>
