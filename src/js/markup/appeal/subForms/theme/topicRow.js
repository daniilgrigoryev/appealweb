                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span className='inline-block mr12'>
                                            <Field disabled={disabled} component={FAutocomplete} name={field + M.CAT.name} props={{readonly: true}}
                                    ...
                                    <td colSpan='6'>
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td><Field disabled={disabled} component={FAutocomplete} props={{readonly: true}} name={field + 'executor_id'} dataKey={M_STATUS.EXECUTOR.key} /></td>
                                            </tr>
                                            <tr>
                                                <td className='ap-input-caption'>Отдел исполнителя</td>
                                                <td><Field disabled={disabled} component={FAutocomplete} props={{readonly: true}} name={field + 'executor_org_id'} dataKey={M_STATUS.DEPART.key} /></td>
                                            </tr>
                                            <tr>
                                            ...
                                            {cif(M.APPEAL_CAUSE.name,
                                                (<tr>
                                                    ...
                                                    <td><Field disabled={disabled} component={FAutocomplete} value={P[M.APPEAL_CAUSE.name]}  props={{readonly: true}}  name={field + M.APPEAL_CAUSE.name} dataKey={M.APPEAL_CAUSE.key}/>
                                                    </td>
                                                </tr>)
                                            )}
                                            {cif(M.DESISION_MAKER.name,
                                                (<tr>
                                                    ...
                                                    <td><Field disabled={disabled} component={FAutocomplete} value={P[M.DESISION_MAKER.name]} props={{readonly: true}} name={field + M.DESISION_MAKER.name} dataKey={M.DESISION_MAKER.key} />
                                                    </td>
                                                </tr>)
                                            )}
                                            {cif(M.DECISION_THEME.name,
                                                (<tr>
                                                    ...
                                                    <td><Field disabled={disabled} component={FAutocomplete} value={P[M.DECISION_THEME.name]}  props={{readonly: true}}  name={field + M.DECISION_THEME.name} dataKey={M.DECISION_THEME.key}/>
                                                    </td>
                                                </tr>)
                                            )}
                                            {cif(M.DECISION_BASIS.name,
                                                (<tr>
                                                    ...
                                                    <td><Field disabled={disabled} component={FAutocomplete} value={P[M.DECISION_BASIS.name]}  props={{readonly: true}}  name={field + M.DECISION_BASIS.name} dataKey={M.DECISION_BASIS.key}/>
                                                    </td>
                                                </tr>)
                                            )}
