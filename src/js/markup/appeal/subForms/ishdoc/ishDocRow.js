                            ...
                            <tr>
                                ...
                                <td>
                                    <span className='inline-block mr12'>
                                        ...
                                        <Field disabled={true} component={FAutocomplete}  readOnly name={field + M.PODPISAL.name} dataKey={M.PODPISAL.key} />
                                    </span>
                                </td>
                                <td>
                                    <span className='inline-block mr12'>
                                        <p className='ap-table__header'>Проверяющий</p>
                                        <Field disabled={disabled} component={FAutocomplete}  readOnly name={field + 'verifier_id'} dataKey={M.PODPISAL.key} />
                                    </span>
                                </td>
                                <td>
                                    {STATUS}
                                ...
                                <td colSpan='6'>
                                    ...
                                    <table className='wmax600'>
                                        ...
                                        <tr>
                                            ...
                                            <td colSpan='3'>
                                                <Field disabled={disabled} component={FAutocomplete} readOnly name={field + M.REL_TOPIC.name} datapromise={tGetter} stoppe='+'/>
                                            </td>                                            
                                        </tr>
                                        <tr>
                                            <td className='ap-input-caption'>{M.DOC_VID.label}</td>
                                            <td><Field disabled={disabled} component={FAutocomplete} readOnly name={field + M.DOC_VID.name}  dataKey={M.DOC_VID.key}/></td>
                                            <td className='ap-input-caption'>{M.DELIV_TYPE.label}</td>
                                            <td><Field disabled={disabled} component={FAutocomplete} readOnly name={field + M.DELIV_TYPE.name} dataKey={M.DELIV_TYPE.key}/></td>
                                        </tr>
                                        <tr>
