                                ...
                                <form className='ml0' onSubmit={handleSubmit}>
                                    <table className='w-full'>
                                        ...
                                        <tr>
                                            ...
                                            <td><Field disabled={disabled} component={FSelect} name={M.REQUEST_TYPE.name} readOnly
                                                       dataKey={M.REQUEST_TYPE.key} placeholder='Выбор'/></td>
                                        </tr>
                                        <tr>
                                            <td className='ap-input-caption'>{M.RESPONSE_TYPE.label}</td>
                                            <td><Field disabled={disabled} component={FSelect} name={M.RESPONSE_TYPE.name} readOnly
